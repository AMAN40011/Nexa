   ...
   <section className='max-w-7xl mx-auto px-8 py-20'>
    ...
    <div className='mt-12 grid gird-cols-1 md:grid-cols-3 gap-8'>
    {
      projects.map((project)=>(
        <div key={project.title} className='group overflow-hidden rounded-xl border bg-white shadow-md hoverhover:-translate-y-2 hover:shadow-xl transition-all duration-300'>
