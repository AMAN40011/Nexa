  ...
  const contactForm = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_API_URL}/user/message`,
        {
          message,
        },
        {
        ...
        <div className="flex flex-col md:flex-row  mt-10">
          <div className="w-full md:w-1/2 text-center md:text-left  flex flex-col items-center md:items-start">
            ...
            <p className="mt-4 text-gray-600">
              ...
              <br /> or simply want to explore an idea, our team is ready to
              help.
            </p>
            <div className="flex flex-col   justify-center ">
              ...
              <div className="bg-blue-50 px-5 py-2 mt-5 rounded-xl  flex items-center">
                <div>
                  <h4 className="font-semibold">We typically respond</h4>
                ...
                <div className="ml-auto">
                  <FaReply className="text-blue-600" size={25} />
                </div>
              </div>
            </div>
          </div>
...
>
        ...
        <div className="mt-15 shadow-md py-6 px-6 bg-blue-50 rounded-xl flex flex-col md:flex-row gap-4 items-center justify-center">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Schedule a free consultation with our experts and <br />
